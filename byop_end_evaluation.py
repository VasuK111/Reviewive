...
"""Training the LDA model as ensemble"""
...
def compute_coherence_values(corpus, dictionary, k, a, b):
    ...
    coherence_model_lda = CoherenceModel(model=model, texts=da, dictionary=id2word, coherence='c_v')
...
# add_model supports various types of input
