...
"""## Removing '' from the dataset & printing it"""

x="""'Wow Loved this place ',
 'Crust is not good ',
...
"""#Importing the spacy library, Tokenising & Lemmatising  the text

I also did the part of speech tagging(Noun/Verb//Adj etc.) to identify dependencies in the text so I can summarise the text easily which is important for the construction of my LDA model in the next part of my project.
"""

import spacy
nlp = spacy.load('en_core_web_sm')
review_string = """Wow Loved this place 
 Crust is not good 
 Not tasty and the texture was just nasty 
 Stopped by during the late May bank holiday off Rick Steve recommendation and loved it 
 The selection on the menu was great and so were the prices 
